...
final class Config extends Vigilant {
    ...
    @Property(
        ...
        description = "Automatically right clicks while you are holding down right click, while holding a bow whose name contains \"Terminator\". This is a cheat. Use at your own risk.",
        category = "QOL", subcategory = "General"
    )
    ...
    /*@Property(
        ...
        description = "Tries to keep the CPS up to the limit even in low TPS conditions by emulating AutoClicker ticks for the dropped ticks. Recommended to enable if you have lowered \"Maximum Ticks Each Frame\" option.",
        category = "QOL", subcategory = "General"
    )
