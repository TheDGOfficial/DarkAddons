...
plugins {
    ...
    id("gg.essential.loom") version "1.7.23"
...
dependencies {
    ...
    implementation("gg.essential:universalcraft-1.8.9-forge:371")
    ...
    testRuntimeOnly("org.junit.platform:junit-platform-launcher:1.12.0-RC1")
