...
dependencies {
    ...
    compileOnly("gg.essential:loader-launchwrapper:1.3.0") // TODO make it shadowMe
    ...
    implementation("gg.essential:universalcraft-1.8.9-forge:449")
    ...
    proguardClasspath("com.guardsquare:proguard-core:9.3.0")
