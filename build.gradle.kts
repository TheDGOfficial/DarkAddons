...
dependencies {
    ...
    compileOnly("gg.essential:loader-launchwrapper:1.3.2") // TODO make it shadowMe
    ...
    api("gg.essential:elementa:714")
    implementation("gg.essential:universalcraft-1.8.9-forge:451")
    ...
    proguardClasspath("com.guardsquare:proguard-core:9.3.1")
