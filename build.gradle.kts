...
dependencies {
    ...
    compileOnly("gg.essential:loader-launchwrapper:1.2.4") // TODO make it shadowMe
    ...
    api("gg.essential:elementa:704")
    implementation("gg.essential:universalcraft-1.8.9-forge:401")
