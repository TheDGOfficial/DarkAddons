...
dependencies {
    ...
    api("gg.essential:elementa-1.8.9-forge:638")
    implementation("gg.essential:universalcraft-1.8.9-forge:325")
    ...
    proguardClasspath("com.guardsquare:proguard-core:9.1.2")
